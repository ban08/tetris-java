...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            Music music = new Music("/music/theme.wav");
            music.runMusic();

            State state = new StartMenuState(screen, music);
    ...
    private static Font loadCustomFont(String resourcePath, float size) throws IOException, FontFormatException {
